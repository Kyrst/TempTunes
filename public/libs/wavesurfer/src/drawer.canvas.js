...
WaveSurfer.util.extend(WaveSurfer.Drawer.Canvas, {
    ...
    drawWave: function (peaks, max) {
		...
		// SoundCloud style
		/*var lingrad = this.waveCc.createLinearGradient(0,0,0,150);
		lingrad.addColorStop(0, '#00ABEB');
		lingrad.addColorStop(0.5, '#fff');
		lingrad.addColorStop(0.5, '#66CC00');
		lingrad.addColorStop(1, '#fff');*/

		var lingrad = this.waveCc.createLinearGradient(0, 0, 0, this.height);
		lingrad.addColorStop(0, this.params.waveStartGradientColor);
		lingrad.addColorStop(1, this.params.waveEndGradientColor);

		this.waveCc.fillStyle = lingrad;
		//this.waveCc.fillStyle = this.params.waveColor;

		var lingrad2 = this.waveCc.createLinearGradient(0, 0, 0, this.height);
		lingrad2.addColorStop(0, this.params.progressStartGradientColor);
		lingrad2.addColorStop(1, this.params.progressEndGradientColor);

		this.progressCc.fillStyle = lingrad2;
